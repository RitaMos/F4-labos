...
\begin{tabular}{@{}C{0.8cm}C{1.9cm}C{1.7cm}C{1.9cm}C{1.9cm}C{1.8cm}C{1.9cm}C{0.8cm}@{}}
    \toprule
    \textbf{Med.} & \textbf{$v_L$ (m/s)} & \textbf{$a^2$} & \textbf{$q$ (C)} & \textbf{$\Delta v_L$ (m/s)} & \textbf{$\Delta a$} & \textbf{$\Delta q$ (C)} \\
    \midrule
    1  & $2{,}1183\times10^{-4}$ & $2{,}1377\times10^{-9}$ & $1{,}6892\times10^{-15}$ & $6{,}2320\times10^{-7}$ & $2{,}9420\times10^{-3}$ & $3{,}22459\times10^{-13}$ \\
    2  & $1{,}7359\times10^{-4}$ & $1{,}7518\times10^{-9}$ & $1{,}1496\times10^{-16}$ & $4{,}1850\times10^{-7}$ & $2{,}4109\times10^{-3}$ & $1{,}98662\times10^{-14}$ \\
    3  & $4{,}2857\times10^{-4}$ & $4{,}3251\times10^{-9}$ & $7{,}9692\times10^{-16}$ & $2{,}5510\times10^{-6}$ & $5{,}9524\times10^{-3}$ & $2{,}16385\times10^{-13}$ \\
    4  & $1{,}0458\times10^{-4}$ & $1{,}0554\times10^{-9}$ & $1{,}1719\times10^{-15}$ & $1{,}5189\times10^{-7}$ & $1{,}4524\times10^{-3}$ & $1{,}57182\times10^{-13}$ \\
    5  & $1{,}8750\times10^{-3}$ & $1{,}8922\times10^{-8}$ & $8{,}8969\times10^{-15}$ & $4{,}8828\times10^{-5}$ & $2{,}6042\times10^{-2}$ & $5{,}05293\times10^{-12}$ \\
    6  & $4{,}1812\times10^{-4}$ & $4{,}2196\times10^{-9}$ & $5{,}9297\times10^{-16}$ & $2{,}4281\times10^{-6}$ & $5{,}8072\times10^{-3}$ & $1{,}59031\times10^{-13}$ \\
    7  & $3{,}0257\times10^{-4}$ & $3{,}0535\times10^{-9}$ & $1{,}6669\times10^{-16}$ & $1{,}2715\times10^{-6}$ & $4{,}2024\times10^{-3}$ & $3{,}80296\times10^{-14}$ \\
    8  & $1{,}1321\times10^{-3}$ & $1{,}1425\times10^{-8}$ & $3{,}9377\times10^{-15}$ & $1{,}7800\times10^{-5}$ & $1{,}5723\times10^{-2}$ & $1{,}73774\times10^{-12}$ \\
    9  & $1{,}1673\times10^{-3}$ & $1{,}1780\times10^{-8}$ & $3{,}9021\times10^{-15}$ & $1{,}8925\times10^{-5}$ & $1{,}6213\times10^{-2}$ & $1{,}74864\times10^{-12}$ \\
    10 & $1{,}7391\times10^{-3}$ & $1{,}7551\times10^{-8}$ & $1{,}0457\times10^{-14}$ & $4{,}2008\times10^{-5}$ & $2{,}4155\times10^{-2}$ & $5{,}71994\times10^{-12}$ \\
    11 & $8{,}1800\times10^{-4}$ & $8{,}2551\times10^{-9}$ & $2{,}1014\times10^{-15}$ & $9{,}2933\times10^{-6}$ & $1{,}1361\times10^{-2}$ & $7{,}88285\times10^{-13}$ \\
    12 & $3{,}2698\times10^{-3}$ & $3{,}2998\times10^{-8}$ & $2{,}0907\times10^{-14}$ & $1{,}4849\times10^{-4}$ & $4{,}5413\times10^{-2}$ & $1{,}568\times10^{-11}$ \\
    \bottomrule
\end{tabular}
\end{table}
...
Para propagar los errores en las mediciones, se utilizó que para una variable dependiente $F(x,y,z)$ el cálculo de su incerteza se realiza mediante la ecuación
\[
\Delta F =
\sqrt{
...
Con el fin de calcular $\Delta q_i$, se notó que las variables de la que la misma dependía eran el radio de cada gota $a_i$ y la tensión necesaria para frenarla, $V_i$, y que a su vez el radio dependía de la velocidad terminal, que dependía de la medición de la distancia y del tiempo. Así, los cálculos de las incertezas resultan ser:
\[
\Delta q_i =
\sqrt{
\left(\frac{\partial q}{\partial a}(a_i,V_i)\cdot \Delta a_i\right)^2
+
\left(\frac{\partial q}{\partial V}(a_i,V_i )\cdot\Delta V\right)^2
}
\]
\[
\Delta a_i = \sqrt{\left(\frac{\partial a}{\partial v_L}(v_{Li})\cdot\Delta v_{Li}\right)^2 }
\]
\[
\Delta v_{Li} = \sqrt{\left(\frac{\partial v_L}{\partial x}(x,t_i)\cdot\Delta x\right)^2
+
\left(\frac{\partial v_L}{\partial t}(x,t_i)\cdot\Delta t\right)^2}
\]
Nótese que las incertezas de la tensión, la distancia x y el tiempo x, así como la distancia recorrida x son iguales para todas las gotas, por lo que no tienen subíndice.

A su vez, las derivadas parciales quedan:
\begin{equation*}
    \frac{\partial v_L}{\partial t} = -\frac{x}{t^2}
\end{equation*}
\begin{equation*}
    \frac{\partial a}{\partial v_L} = -\frac{1}{2\sqrt{\frac{9}{2}\frac{\eta \, v_L}{(\rho-\sigma)g}}} \cdot\frac{9}{2} \frac{\eta}{((\rho-\sigma)g} 
\end{equation*}
\begin{equation*}
    \frac{\partial q}{\partial V} = 3a^2\cdot \frac{4\pi (\rho-\sigma)gx}{3V}=\frac{3q}{a}
\end{equation*}

Las incertidumbres obtenidas directamente de la experiencia son
\begin{itemize}
    \item $\Delta x\approx 0$: la distancia x que la gota recorre en un tiempo t se calcula multiplicando la cantidad de retículos por la longitud de cada retículo, ambos valores que se toman como parámetros sin incertidumbre.
    \item $\Delta t = \pm 0,4\,s$: considera tanto el tiempo de reacción de la persona que realizó la medición como el error del cronómetro.
    \item $\Delta V=\pm 3 \, V$: considera el error del multímetro al medir la diferencia de potencial entre las placas del capacitor.
\end{itemize}

\section{Cálculo de la carga fundamental}

Luego de obtener las cargas de las distintas gotas, para el valor de cada una se obtuvo una función $f(e)$. Esta función mide qué tan compatibles son las cargas que se midieron con la hipótesis de que cada carga es un múltiplo entero de una carga fundamental. Para un rango de valores desde $1 \times 10^{-19}$ C hasta $1{,}7 \times 10^{-19}$ C, dividiendo el intervalo en 25 valores, se definió una función $f(e)$, de manera que el valor de $e$ que la minimizara sea el que mejor coincide con la hipótesis de que todas las cargas experimentales son múltiplos enteros de la carga del electrón. Así, dicha función es:
\[
f(e)=\sum_i\left(\frac{q_i}{e}-q_i^*\right)^2
\]
donde $q_i^*=\left[\frac{q_i}{e}+0,5\right] $.

Con el fin de considerar las incertidumbres experimentales, se obtuvieron los valores de $f(e+\Delta e)$ y $f(e-\Delta e)$ como se puede ver en las ecuaciones \ref{f(e)ConError} para cada valor de e preestablecido. Así, se definió $e_+$ como el valor que minimiza $f(e+\Delta e)$ y $e_-$ como el valor que minimiza $f(e-\Delta e)$, y se estableció que la semisuma de ambos es el valor representativo de e, y la semiresta el valor absoluto de su medición. Las funciones $f(e+\Delta e)$ y $f(e-\Delta e)$ son:
\begin{equation}
    f(e+\Delta e)=\sum_i\left(\frac{q_i+\Delta q_i}{e}-q_i^*\right)^2 
    \qquad \qquad
    f(e-\Delta e)=\sum_i\left(\frac{q_i-\Delta q_i}{e}-q_i^*\right)^2    
\end{equation} \label{f(e)ConError}
(Los valores de $q_i^*$ también se volvieron a calcular reemplazando $q$ por $q_i \pm \Delta q_i$ según correspondía).
...
\begin{tabularx}{\textwidth}{@{}>{\bfseries}L{5.5cm}Y@{}}
    \toprule
    Mínimo con $q_i+\Delta q_i$ & $e_+ = 1,308 \times 10^{-19}$ C \\
    Mínimo con $q_i-\Delta q_i$ & $e_-= 1,448 \times 10^{-19}$ C \\
    \midrule
    Resultado experimental & $e_{\mathrm{exp}} = (1,378 \pm 0,07) \times 10^{-19}$ C \\
    Valor de referencia & $e_{\mathrm{ref}} = 1,602 \times 10^{-19}$ C \\
    \bottomrule
\end{tabularx}
\end{table}

Una vez obtenido $e_{\mathrm{exp}}$ se puede realizar la comparación con el valor de referencia y calcular la diferencia relativa porcentual, definida como
...
El mínimo de $f(e)$ determina el valor de carga fundamental que presenta la mejor concordancia con el conjunto de cargas obtenidas experimentalmente. La existencia de un mínimo definido indica que dichas cargas pueden interpretarse como múltiplos de una misma carga elemental, lo que resulta consistente con el carácter cuantizado de la carga eléctrica. Las desviaciones respecto de esta relación ideal pueden atribuirse principalmente a las incertidumbres introducidas durante la observación y el cronometraje de las gotas, así como a la resolución limitada de los instrumentos utilizados.

\section{Conclusiones}

Mediante la combinación de la caída a velocidad terminal y el equilibrio electrostático se obtuvo la carga de cada gota sin medir directamente su masa ni su radio. El valor deducido para la carga elemental fue $e_{\mathrm{exp}}=(1{,}378\pm0{,}07)\times10^{-19}\,\mathrm{C}$. Este resultado es razonablemente cercano al valor de referencia de $1{,}602\times10^{-19}\,\mathrm{C}$, aunque presenta un desvío relativo del 14 \%. Esta diferencia puede asociarse principalmente a la dificultad para observar y cronometrar las gotas con precisión, debido a su pequeño tamaño y bajo contraste, así como a la resolución limitada de los instrumentos utilizados.
